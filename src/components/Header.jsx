...
const Header = () => {
    ...
    // state to tract if the contact form is open 
  ...
  return (
   <header className="absolute w-full z-50 transition-all duration-300">
    ...
    <nav className="lg:flex hidden space-x-8 ">
            {["Home", "about", "Projects", "Experience", "Profiles",  "Contact"].map((item, index) => (
                <motion.a
        ...
        {/* social section  */}
            <div className="md:flex hidden items-center space-x-4 ">
                ...
                className="text-gray-700 dark:text-gray-300 hover:text-violet-600 dark:hover:text-violet-400 transition-colors duration-300" href="https://github.com/Rishita-Raj">
                ...
                className="text-gray-700 dark:text-gray-300 hover:text-violet-600 dark:hover:text-violet-400 transition-colors duration-300" href="https://www.linkedin.com/in/rishita-raj-836b13290?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app">
            ...
            {/* mobile view (show only when open) */}
                            <motion.div
                ...
                className="md:hidden overflow-hidden bg-white dark:bg-gray-900 shadow-lg px-4 py-5 space-y-5">
                    <nav className="flex flex-col space-y-3">
                        {["Home", "about", "Projects", "Experience", "Profiles",  "Contact"].map((item) => (
                            <a onClick={toggleMenu} className="text-gray-800 dark:text-gray-200 font-medium py-2" key={item} href="#">
                                {item}
                            </a>
                        ))}
                    </nav>
                    ...
                    <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
                        ...
                        <button
                            ...
                            className="mt-4 block w-full px-4 py-2 rounded-lg bg-gradient-to-r from-violet-400 to-violet-400 font-bold">
                                Contact me
                        </button>
                    </div>
                </motion.div>
